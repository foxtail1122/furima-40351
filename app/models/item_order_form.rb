class ItemOrderForm
  ...
  def save
    ...
    Order.create(item_order_id: item_order.id, postal_code: postal_code, prefecture_id: prefecture_id, city: city, adress: adress, building_name: building_name, phone_number: phone_number)
  end
end
